...
import bronwave from '../Images/bronwave.png'
import bord from '../Images/bord.png'
import lightwave from '../Images/lightwave.png'
...
const Joinourteam = () => {
  ...
  return (
    <div className="main-join">
          ...
          <div className="apply-bord"  data-aos="zoom-in-down"
        data-aos-duration="1000">
    
    <img src={bord} id='join'
    />
    ...
    <p>JOIN MENTOONS</p>
        ...
        <Slider {...settings}>
            {data.map((d)=>(
                <div className='bg-white h-[690px] text-black rounded-xl'>
                    <div className=' h-76  rounded-t-xl bg-purple-500 flex justify-center item-center'>
                        <img src={d.img} className='my-5 h-44 w-94 rounded-sm'/>
                 </div>
        ...
        Your responsibilities will include embodying characters,
         conveying emotions, and participating in photoshoots or
          video productions. The ideal candidate will possess exceptional
           acting or modeling skills, a strong stage or on-camera presence,
            and a passion for storytelling through performance. Join us in
             showcasing our vision through your talent and charisma, creating
